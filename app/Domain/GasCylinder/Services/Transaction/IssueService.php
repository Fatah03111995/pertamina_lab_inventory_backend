...
use App\Domain\GasCylinder\Services\Transaction\BaseTransactionService;
...
class IssueService extends BaseTransactionService
{
    ...
    public function reportLost(
        ...
        return DB::transaction(function () use (
            ...
            $header = GasTransactionHeader::create([
                'transaction_type' => GasTransactionType::REPORT_LOST->value,
            ...
            foreach ($cylModels as $cylModel) {
                ...
                $toStatus = GasCylinderStatus::LOST;
    ...
    public function resolveIssue(
        ...
        return DB::transaction(function () use (
            ...
            // Create Header
            $header = GasTransactionHeader::create([
                'transaction_type' => GasTransactionType::RESOLVE_ISSUE->value,
                'document_number' => $documentNumber ?? null,
                'evidence_document' => $evidenceDocument ?? null,
                'from_location_id' => null,
